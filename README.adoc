...
NOTE: If you are using https://github.com/spring-projects/spring-restdocs[Spring REST Docs] with this plugin use v1.5.11 or v1.5.12 of this plugin and do not manually set the version of AsciidoctorJ in your build script.
